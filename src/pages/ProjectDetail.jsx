...
const projects = [
    ...
    { id: 3, year:2024, title: 'Zoom-redesign', image: ZoomRedesign, link: '/projekt-3', githubLink: 'https://github.com/Rodrigo-Sebastian/zoom-redesign', description: 'Design och utveckling av en interaktiv landingsida för Stklm-eat', about: 'Beskrivning av Zoom-redesign', about: 'En clonesite av Zoom:s hero-section, byggd med tailwind & React.', borderColor: 'border-yellow-500' },
